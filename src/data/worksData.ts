...
export const worksData: WorksData = [
{
  ...
  description: [
    ...
    {heading: "使用技術", body: [{ex: "Next.js, Supabase, Vercel Edge Middleware, TypeScript"}]},
    {heading: "主な機能", body: [
      {ex: "- MiddlewareでAIクローラーをリアルタイム検出・記録（UA判定 + ASN補完）"},
    ...
    {heading: "工夫した点", body: [
      ...
      {ex: "- JSON-LDあり（実験群）となし（対照群）のページを並行公開し、クロール頻度の差を実データで記録。公開1日でPerplexityが造語を正確に回答。"},
    ]},
